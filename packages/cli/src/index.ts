...
/**
 * @minions-qa-suites/cli — CLI for Minions Qa-suites
 *
...
import { customTypes } from '@minions-qa-suites/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Qa-suites'));
        console.log(chalk.dim('Test suite definitions, test cases, and assertions for validating clawspace toolboxes'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-qa-suites/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-qa-suites/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-qa-suites')}`);
